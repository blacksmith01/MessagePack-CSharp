...
namespace ");
 ...
 foreach (var objInfo in ObjectSerializationInfos) {
    bool isFormatterResolverNecessary = ShouldUseFormatterResolverHelper.ShouldUseFormatterResolver(objInfo.Members);
            ...
            this.Write(" : global::MessagePack.Formatters.IMessagePackExFormatter<");
 ...
 if (objInfo.HasIMessagePackSerializationCallbackReceiver) {
  if (objInfo.NeedsCastOnAfter) { 
            ...
            this.Write("        }\r\n\r\n        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(objInfo.FullName));
            this.Write(" DeserializeEx(ref global::MessagePack.MessagePackReader reader, ");
            this.Write(this.ToStringHelper.ToStringWithCulture(objInfo.FullName));
            this.Write(" value, global::MessagePack.MessagePackSerializerOptions options)\r\n        {\r\n   " +
 ...
 for (var memberIndex = 0; memberIndex <= objInfo.MaxKey; memberIndex++) {
  ...
  if (member == null) { continue; } 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(member.IntKey));
            this.Write(":\r\n");
 if (member.IsClass && !member.IsString) { 
 if (member.IsWritable && (member.IsString || !member.IsClass)) { 
            this.Write("                        value.");
            this.Write(this.ToStringHelper.ToStringWithCulture(member.Name));
            this.Write(" = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(member.GetDeserializeMethodStringEx($"member.{member.Name}")));
            this.Write(";\r\n");
 } else { 
            this.Write("                        if(value.");
            this.Write(this.ToStringHelper.ToStringWithCulture(member.Name));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(member.Type));
            this.Write("();\r\n                        }\r\n                        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(member.GetDeserializeMethodStringEx($"value.{member.Name}")));
            this.Write(";\r\n");
 } 
 } else { 
 if (member.IsWritable) { 
 ...
 if (objInfo.HasIMessagePackSerializationCallbackReceiver) {
  if (objInfo.NeedsCastOnAfter) { 
            ...
            this.Write("            value.OnAfterDeserialize();\r\n");
 } 
 } 
            this.Write("            reader.Depth--;\r\n            return value;\r\n");
 } 
